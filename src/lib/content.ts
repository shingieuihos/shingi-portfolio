...
export const about = {
  intro:
    "I'm an AWS-focused cloud engineer and product builder. I lead engineering at SubSaharaData, run PeakRank Digital as founder, and direct WhatTheWordSays — a digital ministry reaching tens of thousands. Twenty years of ministry leadership shapes how I build: long horizons, real users, plain language.",
  story:
